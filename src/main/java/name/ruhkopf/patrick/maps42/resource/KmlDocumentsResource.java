...
@Component
@Scope("request")
public class KmlDocumentsResource
{
	/** The map service. */
	 ...
	 */
	@Autowired
	public KmlDocumentsResource(KmlService kmlService)
	{
		super();
	...
	public Response createNewKml(Kml requestDoc)
	{
		Kml responseDoc = kmlService.createNewKmlDocument(requestDoc);
